...
def main():
    ...
    with col1:
        ...
        st.markdown("[Explore Project](https://artsandculture.google.com/experiment/say-what-you-see/jwG3m7wQShZngw?hl=en)", unsafe_allow_html=True)
    ...
    with col7:
        ...
        st.markdown("[Explore Project](project7.py)", unsafe_allow_html=True)
